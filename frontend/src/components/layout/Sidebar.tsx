...
import { BarChart3, Building2, GitCompare, Target, Search, Activity, Sun, Moon, Zap, BookOpen, Network, Triangle, History } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/three-axis', icon: Triangle, label: '3축 분석' },
  { to: '/trend-history', icon: History, label: '트렌드 히스토리' },
]
